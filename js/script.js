...
function getNumberInfo() {
    ...
    if (isNaN(num) || num.length == 0 || num < 2 || num > 10000 || (num.length > 1 && num[0] == "0") || !Number.isInteger(Number(num))) {
        txt += `Invalid Input.  Please enter a whole number between 2 and 10000.  Do not include leading zeros.`;
    } else {
